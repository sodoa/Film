 ...
 * 
 */
public class EhcacheCacheProvider implements CacheProvider, FactoryBean<Ehcache>, BeanNameAware, InitializingBean  {
	
	protected final Logger logger = LoggerFactory
			.getLogger(EhCacheManagerFacotryBean.class);
	...
	public void setAttribute(String root, Serializable session, int exp) {
		cache.put(new Element(root, session, exp));
	}
